...
public class JwtRequestFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        System.out.println("JwtRequestFilter: Processing request to " + request.getServletPath());

        if (request.getServletPath().equals("/api/auth/login") || request.getServletPath().equals("/api/auth/register")) {
            System.out.println("JwtRequestFilter: Skipping authentication for " + request.getServletPath());
